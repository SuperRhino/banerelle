...
class InsertTestData extends AbstractMigration
{
    public function up()
    {
        $insert = 'INSERT INTO `events` (`id`, `title`,`description`,`details`,`post_date`,`event_date`) VALUES
                   ...
                   (2, "Heading Two", "Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod.", 1, NOW(), NULL),
